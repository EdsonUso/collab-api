...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        log.info("informações carregadas para gerar JWT via OAuth: {}", user);

        // Injeta dados do usuário nos atributos para o SuccessHandler poder gerar o JWT
        Map<String, Object> enrichedAttributes = new java.util.HashMap<>(oAuth2User.getAttributes());
